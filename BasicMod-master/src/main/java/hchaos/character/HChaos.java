...
import hchaos.cards.*;
import hchaos.relics.SixInTheChamber;

import java.util.ArrayList;

import static hchaos.HChaos.characterPath;
import static hchaos.HChaos.makeID;

public class HChaos extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("HChaos"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass H_Chaos;
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Strike_Ceru.ID);
        retVal.add(Defend_Ceru.ID);
        retVal.add(Defend_Ceru.ID);
        retVal.add(Reload.ID);
        retVal.add(SteadyAim.ID);
        retVal.add(Strike_Ceru.ID);
